...
class _NotificationApiService implements NotificationApiService {
  ...
  Future<HttpResponse<PageResponse<NotificationResponse>>> getNotifications(
    ...
    final _options =
        _setStreamType<HttpResponse<PageResponse<NotificationResponse>>>(
    ...
    late PageResponse<NotificationResponse> _value;
    try {
      _value = PageResponse<NotificationResponse>.fromJson(
        _result.data!,
  ...
  @override
  Future<HttpResponse<int>> getUnreadCount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<NotificationResponse>> markAsRead(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<NotificationResponse>>(
  ...
  @override
  Future<HttpResponse<void>> deleteNotification(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<void>> deleteAll() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
